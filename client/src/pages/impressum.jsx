...
function Impressum() {
  return (
    <div className="container mx-auto my-8 px-4 text-gray-800 max-w-800">
      ...
      <ul className="list-disc pl-8 mb-4">
        ...
        <li>
          <p>
            ...
            this Agreement) refers to AEY Buddies, MysteriousCity 8321.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to StayVista, accessible from{" "}
            <a
              href="http://not.real.com"
      ...
      <ul>
        <li>By email: yannickschlaepfer188@gmail.com</li>
      </ul>
    </div>
  );
}
